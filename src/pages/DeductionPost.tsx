...
export default function DeductionPost() {
  ...
  // If no slug provided, default to latest post
  const post = slug 
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 w-full mt-24">
      <Link to="/deductions" className="font-label text-xs uppercase tracking-widest text-primary mb-8 inline-block hover:underline">
      ...
      <article className="mb-24">
        ...
        {post.attributes.cover && (
          <div className="w-full h-[400px] md:h-[500px] mb-20 bg-surface-container-low rounded flex items-center justify-center overflow-hidden relative group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 relative">
          ...
          <aside className="hidden lg:block lg:col-span-3">
            <div className="sticky top-32 bg-surface-container-lowest p-6 rounded outline outline-1 outline-outline-variant/20 shadow-[0_20px_40px_rgba(79,35,31,0.05)]">
              <h3 className="font-label text-xs uppercase tracking-widest text-primary mb-6 border-b border-outline-variant/30 pb-2">Forensic Metadata</h3>
          ...
          <div className="lg:col-span-8 max-w-none prose prose-invert prose-p:font-body prose-p:text-lg prose-p:leading-loose prose-p:text-on-surface prose-headings:font-headline prose-headings:text-on-surface prose-a:text-primary prose-blockquote:border-primary/50 prose-blockquote:bg-surface-container-low prose-blockquote:p-4 prose-blockquote:rounded">
